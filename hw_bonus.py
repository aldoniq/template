...
takes a positive integer 'n' and returns the smallest prime divisor of 
'n'.
...
Write a function "check_divisible_by_any(n: int, divisors: str) -> bool" 
that 
takes a positive integer 'n' and a string 'divisors' containing a sequence 
of 
